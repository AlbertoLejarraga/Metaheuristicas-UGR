...
def lanzar(setEjemplos, random, alfa=0.5, sigma=0.3):
    inicio=time.time()
    ...
    numCaracteristicas=setEjemplos[0].__len__()-1
    ...
    while(contador<15000 and vecinosExplorados < (20*numCaracteristicas)):
        mejora=False
        ...
        while(not mejora and modificadas<numCaracteristicas):
            ...
            solucionActual = generarVecino(mejorSolucion,distNormal,caractAModificar)
