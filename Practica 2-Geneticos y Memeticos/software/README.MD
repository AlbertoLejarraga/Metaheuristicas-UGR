En la carpeta data se encuentran las poblaciones iniciales, que se pueden borrar para generarlas de nuevo, aunque siempre serán las mismas como se detalla en el documento
...
geneticos.py: archivo con los distintos algoritmos genéticos realizados